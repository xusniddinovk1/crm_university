...
from core.models.teacher import Course, Department, Teacher
from core.serializers.group import GroupStudentSerializer
from core.serializers.teacher import CourseSerializer, DepartmentSerializer, TeacherSerializer
from core.permissions import *


# departments uchun
class DepartmentsViewSet(ModelViewSet):
    queryset = Department.objects.all()  # Barcha departmentsni olish
